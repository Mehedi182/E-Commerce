...
<html lang="en">
  ...
  <head>
    ...
    <!-- font awesome-->
    <script src="https://kit.fontawesome.com/926e391776.js" crossorigin="anonymous"></script>  </head>

  <body>

    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><img src="{{ asset('images/logo.png') }}" height="70px" width="230px" style="margin-left:-20px" alt=""></a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Order Status</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('dashboard') }}/img/img3.jpg" class="wd-32 rounded-circle" alt="">
            </a>
          ...
          <div class="media-list">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="{{ asset('dashboard') }}/img/img8.jpg" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
