...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> mehedihasan152201@gmail.com</li>
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    @else
                                        <li class="nav-item dropdown">
                                            <a href="/user/profile">
                                                <p class="fa fa-user">{{ Auth::user()->name }}</p>
                    ...
                    <div class="header__cart">
                        ...
                        <ul>
                            <li><a href="/wishlist"><i class="fa fa-heart"></i>
                                    <span>{{ count($wishlist_quantity) }}</span></a></li>
                            <li><a href="/cart"><i class="fa fa-shopping-bag"></i> <span>{{ $quantity }}</span></a>
                            </li>
                        </ul>
