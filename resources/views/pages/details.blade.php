    ...
    <body>
                ...
                <div class="row">
                        ...
                        <div class="product__details__pic">
                            ...
                            <div class="product__details__pic__slider owl-carousel">
                                ...
                                <img data-imgbigurl="{{ asset('images/products/' . $product->imagethree) }}"
                                    src="{{ asset('images/products/' . $product->imagethree) }}" alt="">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product__details__text">
                            ...
                            <a href="/add/to-wishlist/{{ $product->id }}" class="heart-icon"><span class="icon_heart_alt"></span></a>
        ...
        <section class="related-product">
            <div class="container">
                ...
                <div class="row">
                    @foreach ($related_products as $rel_pro)


                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg"
                                    data-setbg="{{ asset('images/products/' . $rel_pro->firstImage) }}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="/add/to-wishlist/{{ $rel_pro->id }}"><i
                                                    class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <form action="/add/to-cart/{{ $rel_pro->id }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="price" value="{{ $rel_pro->price }}">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">{{ $rel_pro->name }}</a></h6>
                                    <h5>Tk {{ $rel_pro->price }}</h5>
                                </div>
                            </div>
                        </div>
                    @endforeach
